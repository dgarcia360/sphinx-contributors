# Contributing to sphinxcontrib-ghcontributors

First off, thank you for considering contributing to sphinxcontrib-ghcontributors. 
It’s people like you that make sphinxcontrib-ghcontributors such a great tool.

sphinxcontrib-ghcontributors is an open source project and we love to receive contributions from 
...
writing code which can be incorporated into sphinxcontrib-ghcontributors itself.
...
If you think you have found a bug in sphinxcontrib-ghcontributors, first make sure that you 
are testing against the latest version of sphinxcontrib-ghcontributors - your issue may already 
...
If you find yourself wishing for a feature that doesn't exist in sphinxcontrib-ghcontributors, 
you are probably not alone. There are bound to be others out there with similar 
needs. Many of the features that sphinxcontrib-ghcontributors has today have been added because 
our users saw the need. Open an [issue][github-issues] on our issues list on GitHub which describes 
the feature you would like to see, why you need it, and how it should work.

## Contributing code and documentation changes

If you have a bugfix or new feature that you would like to contribute to sphinxcontrib-ghcontributors, please find or open an issue 
...
You will need to fork the main sphinxcontrib-ghcontributors code or documentation repository and clone 
...
Then sit back and wait. There will probably be discussion about the pull request and, if any changes are needed, we would love to work with you to get your pull request merged into sphinxcontrib-ghcontributors.

*CONTRIBUTING.md is based on [CONTRIBUTING-template.md](https://github.com/nayafia/contributing-template/blob/master/CONTRIBUTING-template.md)* , [elasticsearch/CONTRIBUTING](https://github.com/elastic/elasticsearch/blob/master/CONTRIBUTING.md) and [spark/CONTRIBUTING](https://github.com/apache/spark/blob/master/CONTRIBUTING.md)

[pull-request]: https://help.github.com/articles/about-pull-requests/
[github-issues]: https://github.com/dgarcia360/sphinxcontrib-ghcontributors/issues